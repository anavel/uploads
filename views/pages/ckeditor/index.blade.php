...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            @if ($previousDirectory !== null)
            <a href="{{ route('anavel-uploads.ckeditor.file-browser', array_merge(Request::query(), ['dir' => $previousDirectory])) }}"><i class="fa fa-arrow-left"></i> {{ trans('anavel-uploads::messages.back_button') }}</a>
            @endif
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-2">
                    @if ($object->isDir())
                    <a href="{{ route('anavel-uploads.ckeditor.file-browser', array_merge(Request::query(), ['dir' => $object->getPath()])) }}">
                        {!! $object->getThumbnail() !!}
                    </a>
                    @else
